...
const translations = {
	"Comprehensive task management plugin for Obsidian with progress bars, task status cycling, and advanced task tracking features.":
		"Plugin abrangente de gerenciamento de tarefas para Obsidian com barras de progresso, ciclo de status de tarefas e recursos avançados de acompanhamento de tarefas.",
	"Show progress bar": "Mostrar barra de progresso",
	"Toggle this to show the progress bar.":
		"Ative para mostrar a barra de progresso.",
	"Support hover to show progress info":
		"Suporte para mostrar informações de progresso ao passar o mouse",
	"Toggle this to allow this plugin to show progress info when hovering over the progress bar.":
		"Ative para permitir que este plugin mostre informações de progresso ao passar o mouse sobre a barra de progresso.",
	"Add progress bar to non-task bullet":
		"Adicionar barra de progresso a itens de lista comuns",
	"Toggle this to allow adding progress bars to regular list items (non-task bullets).":
		"Ative para permitir adicionar barras de progresso a itens de lista regulares (marcadores não relacionados a tarefas).",
	...
	"Toggle this to allow this plugin to add progress bar for Task below the headings.":
		"Ative para permitir que este plugin adicione uma barra de progresso para Tarefas abaixo dos cabeçalhos.",
	...
	"Add progress bars to headings to show progress of all tasks under that heading.":
		"Adicione barras de progresso aos cabeçalhos para mostrar o progresso de todas as tarefas sob esse cabeçalho.",
	...
	"Toggle this to allow this plugin to auto complete parent task when all child tasks are completed.":
		"Ative para permitir que este plugin complete automaticamente a tarefa pai quando todas as tarefas filhas forem concluídas.",
	"Mark parent as 'In Progress' when partially complete":
		"Marcar pai como 'Em Andamento' quando parcialmente concluído",
	"When some but not all child tasks are completed, mark the parent task as 'In Progress'. Only works when 'Auto complete parent' is enabled.":
		"Quando algumas, mas não todas as tarefas filhas estiverem concluídas, marque a tarefa pai como 'Em Andamento'. Só funciona quando 'Completar tarefa pai automaticamente' está ativado.",
	"Count sub children level of current Task":
		"Contar níveis de sub-tarefas da Tarefa atual",
	"Toggle this to allow this plugin to count sub tasks.":
		"Ative para permitir que este plugin conte sub-tarefas.",
	...
	"Select a predefined task status collection or customize your own":
		"Selecione uma coleção predefinida de status de tarefa ou personalize a sua",
	...
	'Characters in square brackets that represent completed tasks. Example: "x|X"':
		'Caracteres entre colchetes que representam tarefas concluídas. Exemplo: "x|X"',
	"Planned task markers": "Marcadores de tarefa planejada",
	'Characters in square brackets that represent planned tasks. Example: "?"':
		'Caracteres entre colchetes que representam tarefas planejadas. Exemplo: "?"',
	...
	'Characters in square brackets that represent tasks in progress. Example: ">|/"':
		'Caracteres entre colchetes que representam tarefas em andamento. Exemplo: ">|/"',
	...
	'Characters in square brackets that represent abandoned tasks. Example: "-"':
		'Caracteres entre colchetes que representam tarefas abandonadas. Exemplo: "-"',
	'Characters in square brackets that represent not started tasks. Default is space " "':
		'Caracteres entre colchetes que representam tarefas não iniciadas. O padrão é espaço " "',
	"Count other statuses as": "Contar outros status como",
	'Select the status to count other statuses as. Default is "Not Started".':
		'Selecione o status para o qual outros status devem ser contados. O padrão é "Não Iniciada".',
	...
	'Specify task markers to exclude from counting. Example: "?|/"':
		'Especifique marcadores de tarefa a serem excluídos da contagem. Exemplo: "?|/"',
	"Only count specific task markers":
		"Contar apenas marcadores de tarefa específicos",
	"Toggle this to only count specific task markers":
		"Ative para contar apenas marcadores de tarefa específicos",
	"Specific task markers to count":
		"Marcadores de tarefa específicos para contar",
	'Specify which task markers to count. Example: "x|X|>|/"':
		'Especifique quais marcadores de tarefa contar. Exemplo: "x|X|>|/"',
	"Conditional Progress Bar Display":
		"Exibição Condicional da Barra de Progresso",
	"Hide progress bars based on conditions":
		"Ocultar barras de progresso com base em condições",
	"Toggle this to enable hiding progress bars based on tags, folders, or metadata.":
		"Ative para habilitar a ocultação de barras de progresso com base em tags, pastas ou metadados.",
	...
	'Specify tags that will hide progress bars (comma-separated, without #). Example: "no-progress-bar,hide-progress"':
		'Especifique tags que ocultarão barras de progresso (separadas por vírgula, sem #). Exemplo: "sem-barra-progresso,ocultar-progresso"',
	...
	'Specify folder paths that will hide progress bars (comma-separated). Example: "Daily Notes,Projects/Hidden"':
		'Especifique caminhos de pasta que ocultarão barras de progresso (separados por vírgula). Exemplo: "Notas Diárias,Projetos/Ocultos"',
	...
	'Specify frontmatter metadata that will hide progress bars. Example: "hide-progress-bar: true"':
		'Especifique metadados do frontmatter que ocultarão barras de progresso. Exemplo: "ocultar-barra-progresso: true"',
	...
	"Enable/disable the ability to cycle through task states by clicking.":
		"Ativar/desativar a capacidade de alternar entre os status da tarefa clicando.",
	...
	"Replace default checkboxes with styled text marks that follow your task status cycle when clicked.":
		"Substitua as caixas de seleção padrão por marcadores de texto estilizados que seguem o ciclo de status da sua tarefa ao serem clicados.",
	"Enable cycle complete status":
		"Permitir que o status 'Concluída' faça parte do ciclo de status",
	"Enable/disable the ability to automatically cycle through task states when pressing a mark.":
		"Ativar/desativar a capacidade de alternar automaticamente entre os status da tarefa ao pressionar um marcador.",
	...
	"When enabled, newly inserted tasks will immediately cycle to the next status. When disabled, newly inserted tasks with valid marks will keep their original mark.":
		"Quando ativado, tarefas recém-inseridas irão imediatamente para o próximo status. Quando desativado, tarefas recém-inseridas com marcadores válidos manterão seu marcador original.",
	...
	"Define task states and their corresponding marks. The order from top to bottom defines the cycling sequence.":
		"Defina os status da tarefa e seus marcadores correspondentes. A ordem de cima para baixo define a sequência de ciclo.",
	...
	"A link to the current file will be added to the parent task of the moved tasks.":
		"Um link para o arquivo atual será adicionado à tarefa pai das tarefas movidas.",
	"Say Thank You": "Agradeça",
	Donate: "Doar",
	"If you like this plugin, consider donating to support continued development:":
		"Se você gosta deste plugin, considere doar para apoiar o desenvolvimento contínuo:",
	...
	"Toggle this to allow this plugin to add tasks number to progress bar.":
		"Ative para permitir que este plugin adicione o número de tarefas à barra de progresso.",
	"Show percentage": "Mostrar porcentagem",
	"Toggle this to allow this plugin to show percentage in the progress bar.":
		"Ative para permitir que este plugin mostre a porcentagem na barra de progresso.",
	...
	"Toggle this to customize text representation for different progress percentage ranges.":
		"Ative para personalizar a representação de texto para diferentes intervalos de porcentagem de progresso.",
	"Progress Ranges": "Intervalos de Progresso",
	"Define progress ranges and their corresponding text representations.":
		"Defina intervalos de progresso e suas representações textuais correspondentes.",
	"Add new range": "Adicionar novo intervalo",
	"Add a new progress percentage range with custom text":
		"Adicionar um novo intervalo de porcentagem de progresso com texto personalizado",
	...
	"Toggle to enable priority picker dropdown for emoji and letter format priorities.":
		"Ative para habilitar o seletor de prioridade suspenso para prioridades em formato de emoji e letra.",
	"Enable priority picker": "Ativar seletor de prioridade",
	"Enable priority keyboard shortcuts":
		"Ativar atalhos de teclado para prioridade",
	"Toggle to enable keyboard shortcuts for setting task priorities.":
		"Ative para habilitar atalhos de teclado para definir prioridades de tarefas.",
	...
	"Toggle this to enable date picker for tasks. This will add a calendar icon near your tasks which you can click to select a date.":
		"Ative para habilitar o seletor de data para tarefas. Isso adicionará um ícone de calendário perto de suas tarefas, no qual você pode clicar para selecionar uma data.",
	"Date mark": "Marcador de data",
	"Emoji mark to identify dates. You can use multiple emoji separated by commas.":
		"Marcador de emoji para identificar datas. Você pode usar múltiplos emojis separados por vírgulas.",
	...
	"Toggle this to enable Org-mode style quick capture panel. Press Alt+C to open the capture panel.":
		"Ative para habilitar o painel de captura rápida no estilo Org-mode. Pressione Alt+C para abrir o painel de captura.",
	...
	"The file where captured text will be saved. You can include a path, e.g., 'folder/Quick Capture.md'":
		"O arquivo onde o texto capturado será salvo. Você pode incluir um caminho, ex.: 'pasta/Captura Rápida.md'",
	"Placeholder text": "Texto de espaço reservado",
	"Placeholder text to display in the capture panel":
		"Texto de espaço reservado para exibir no painel de captura",
	...
	"If enabled, captured text will be appended to the target file. If disabled, it will replace the file content.":
		"Se ativado, o texto capturado será anexado ao arquivo de destino. Se desativado, substituirá o conteúdo do arquivo.",
	"Task Filter": "Filtro de Tarefas",
	"Enable Task Filter": "Ativar Filtro de Tarefas",
	"Toggle this to enable the task filter panel":
		"Ative para habilitar o painel de filtro de tarefas",
	"Preset Filters": "Filtros Predefinidos",
	"Create and manage preset filters for quick access to commonly used task filters.":
		"Crie e gerencie filtros predefinidos para acesso rápido a filtros de tarefas usados comumente.",
	...
	"Include or exclude tasks based on their status":
		"Incluir ou excluir tarefas com base em seu status",
	...
	"Include parent, child, and sibling tasks in the filter":
		"Incluir tarefas pai, filha e irmãs no filtro",
	...
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1'":
		"Use operações booleanas: AND, OR, NOT. Exemplo: 'conteúdo do texto AND #tag1'",
	...
	"If enabled, tasks that match the query will be hidden, otherwise they will be shown":
		"Se ativado, tarefas que correspondem à consulta serão ocultadas; caso contrário, serão mostradas.",
	Save: "Salvar",
	Cancel: "Cancelar",
	...
	"Select a saved filter preset to apply":
		"Selecione uma predefinição de filtro salva para aplicar",
	...
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Supports >, <, =, >=, <=, != for PRIORITY and DATE.":
		"Use operações booleanas: AND, OR, NOT. Exemplo: 'conteúdo do texto AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Suporta >, <, =, >=, <=, != para PRIORITY e DATE.",
	"If true, tasks that match the query will be hidden, otherwise they will be shown":
		"Se verdadeiro, tarefas que correspondem à consulta serão ocultadas; caso contrário, serão mostradas.",
	Completed: "Concluída",
	...
	"Capture thoughts, tasks, or ideas...":
		"Capture pensamentos, tarefas ou ideias...",
	Tomorrow: "Amanhã",
	"In 2 days": "Em 2 dias",
	"In 3 days": "Em 3 dias",
	"In 5 days": "Em 5 dias",
	...
	"Move all completed subtasks to another file":
		"Mover todas as sub-tarefas concluídas para outro arquivo",
	"Move direct completed subtasks to another file":
		"Mover sub-tarefas concluídas diretas para outro arquivo",
	"Move all subtasks to another file":
		"Mover todas as sub-tarefas para outro arquivo",
	...
	"Choose whether to include or exclude tasks that match the filters":
		"Escolha se deseja incluir ou excluir tarefas que correspondem aos filtros",
	...
	"Choose whether to show or hide tasks that match the filters":
		"Escolha se deseja mostrar ou ocultar tarefas que correspondem aos filtros",
	...
	"Add child task with same stage":
		"Adicionar tarefa filha com a mesma etapa",
	"Could not open quick capture panel in the current editor":
		"Não foi possível abrir o painel de captura rápida no editor atual",
	...
	"You can customize the progress bar behind the parent task(usually at the end of the task). You can also customize the progress bar for the task below the heading.":
		"Você pode personalizar a barra de progresso atrás da tarefa pai (geralmente no final da tarefa). Você também pode personalizar a barra de progresso para a tarefa abaixo do cabeçalho.",
	...
	"Change the parent task of the current task.":
		"Altere a tarefa pai da tarefa atual.",
	"No preset filters created yet. Click 'Add New Preset' to create one.":
		"Nenhum filtro predefinido criado ainda. Clique em 'Adicionar Nova Predefinição' para criar um.",
	"Configure task workflows for project and process management":
		"Configurar fluxos de trabalho de tarefas para gerenciamento de projetos e processos",
	"Enable workflow": "Ativar fluxo de trabalho",
	"Toggle to enable the workflow system for tasks":
		"Ative para habilitar o sistema de fluxo de trabalho para tarefas",
	...
	"Calculate the full spent time from the start of the task to the last stage":
		"Calcular o tempo gasto total desde o início da tarefa até a última etapa",
	"Auto remove last stage marker":
		"Remover automaticamente marcador da última etapa",
	"Automatically remove the last stage marker when a task is completed":
		"Remover automaticamente o marcador da última etapa quando uma tarefa é concluída",
	...
	"Automatically create a new task with the next stage when completing a task":
		"Criar automaticamente uma nova tarefa com a próxima etapa ao concluir uma tarefa",
	"Workflow definitions": "Definições de fluxo de trabalho",
	"Configure workflow templates for different types of processes":
		"Configure modelos de fluxo de trabalho para diferentes tipos de processos",
	"No workflow definitions created yet. Click 'Add New Workflow' to create one.":
		"Nenhuma definição de fluxo de trabalho criada ainda. Clique em 'Adicionar Novo Fluxo de Trabalho' para criar uma.",
	...
	"A unique identifier for the workflow (used in tags)":
		"Um identificador único para o fluxo de trabalho (usado em tags)",
	Description: "Descrição",
	"Optional description for the workflow":
		"Descrição opcional para o fluxo de trabalho",
	"Describe the purpose and use of this workflow...":
		"Descreva o propósito e uso deste fluxo de trabalho...",
	"Workflow Stages": "Etapas do Fluxo de Trabalho",
	"No stages defined yet. Add a stage to get started.":
		"Nenhuma etapa definida ainda. Adicione uma etapa para começar.",
	Edit: "Editar",
	...
	"A descriptive name for this workflow stage":
		"Um nome descritivo para esta etapa do fluxo de trabalho",
	"Stage ID": "ID da etapa",
	"A unique identifier for the stage (used in tags)":
		"Um identificador único para a etapa (usado em tags)",
	"Stage type": "Tipo de etapa",
	"The type of this workflow stage":
		"O tipo desta etapa do fluxo de trabalho",
	...
	"The stage to proceed to after this one":
		"A etapa para a qual prosseguir após esta",
	"Sub-stages": "Subetapas",
	"Define cycle sub-stages (optional)":
		"Definir subetapas do ciclo (opcional)",
	...
	"Additional stages that can follow this one (for right-click menu)":
		"Etapas adicionais que podem seguir esta (para o menu de clique com o botão direito)",
	"No additional destination stages defined.":
		"Nenhuma etapa de destino adicional definida.",
	Remove: "Remover",
	Add: "Adicionar",
	...
	"This will replace all your current presets with the default set. Are you sure?":
		"Isso substituirá todas as suas predefinições atuais pelo conjunto padrão. Tem certeza?",
	"Edit Workflow": "Editar Fluxo de Trabalho",
	General: "Geral",
	"Progress Bar": "Barra de Progresso",
	...
	"Toggle this to allow this plugin to count sub tasks when generating progress bar\t.":
		"Ative para permitir que este plugin conte sub-tarefas ao gerar a barra de progresso.",
	"Configure task status settings":
		"Configurar definições de status da tarefa",
	"Configure which task markers to count or exclude":
		"Configurar quais marcadores de tarefa contar ou excluir",
	...
	"View the documentation for this plugin":
		"Veja a documentação para este plugin",
	...
	"Use placeholders like {{COMPLETED}}, {{TOTAL}}, {{PERCENT}}, etc.":
		"Use marcadores como {{COMPLETED}}, {{TOTAL}}, {{PERCENT}}, etc.",
	...
	"Available placeholders: {{COMPLETED}}, {{TOTAL}}, {{IN_PROGRESS}}, {{ABANDONED}}, {{PLANNED}}, {{NOT_STARTED}}, {{PERCENT}}, {{COMPLETED_SYMBOL}}, {{IN_PROGRESS_SYMBOL}}, {{ABANDONED_SYMBOL}}, {{PLANNED_SYMBOL}}":
		"Marcadores disponíveis: {{COMPLETED}}, {{TOTAL}}, {{IN_PROGRESS}}, {{ABANDONED}}, {{PLANNED}}, {{NOT_STARTED}}, {{PERCENT}}, {{COMPLETED_SYMBOL}}, {{IN_PROGRESS_SYMBOL}}, {{ABANDONED_SYMBOL}}, {{PLANNED_SYMBOL}}",
	"Expression examples": "Exemplos de expressão",
	"Examples of advanced formats using expressions":
		"Exemplos de formatos avançados usando expressões",
	...
	"Toggle this to show percentage instead of completed/total count.":
		"Ative para mostrar porcentagem em vez da contagem de concluídas/total.",
	...
	"Toggle this to customize the text for different progress ranges.":
		"Ative para personalizar o texto para diferentes intervalos de progresso.",
	...
	"Support expression in format, like using data.percentages to get the percentage of completed tasks. And using math or even repeat operations to get the result.":
		"Suporte a expressões no formato, como usar data.percentages para obter a porcentagem de tarefas concluídas. E usar matemática ou até operações de repetição para obter o resultado.",
	"Support expression in format, like using data.percentages to get the percentage of completed tasks. And using math or even repeat functions to get the result.":
		"Suporte a expressões no formato, como usar data.percentages para obter a porcentagem de tarefas concluídas. E usar matemática ou até funções de repetição para obter o resultado.",
	"Target File:": "Arquivo de Destino:",
	...
	"No tasks in the selected projects":
		"Nenhuma tarefa nos projetos selecionados",
	"Select a project to see related tasks":
		"Selecione um projeto para ver tarefas relacionadas",
	...
	"Select a project to review its tasks.":
		"Selecione um projeto para revisar suas tarefas.",
	...
	"Showing all tasks, including completed tasks from previous reviews.":
		"Mostrando todas as tarefas, incluindo tarefas concluídas de revisões anteriores.",
	"Show only new and in-progress tasks":
		"Mostrar apenas tarefas novas e em andamento",
	...
	"No review schedule configured for this project":
		"Nenhuma agenda de revisão configurada para este projeto",
	...
	"Select a project from the left sidebar to review its tasks.":
		"Selecione um projeto na barra lateral esquerda para revisar suas tarefas.",
	Inbox: "Caixa de Entrada",
	Flagged: "Sinalizadas",
	Review: "Revisão",
	"tags selected": "tags selecionadas",
	"No tasks with the selected tags":
		"Nenhuma tarefa com as tags selecionadas",
	"Select a tag to see related tasks":
		"Selecione uma tag para ver tarefas relacionadas",
	...
	"Clearing task cache and rebuilding index...":
		"Limpando cache de tarefas e reconstruindo índice...",
	"Task index completely rebuilt":
		"Índice de tarefas completamente reconstruído",
	...
	"Task Genius view is a comprehensive view that allows you to manage your tasks in a more efficient way.":
		"A visualização Task Genius é uma visualização abrangente que permite gerenciar suas tarefas de forma mais eficiente.",
	...
	"Task must contain this path (case-insensitive).":
		"A tarefa deve conter este caminho (não diferencia maiúsculas/minúsculas).",
	"Path Excludes": "Caminho Exclui",
	"Task must NOT contain this path (case-insensitive).":
		"A tarefa NÃO deve conter este caminho (não diferencia maiúsculas/minúsculas).",
	...
	"Configure the Task Genius sidebar views, visibility, order, and create custom views.":
		"Configure as visualizações da barra lateral do Task Genius, visibilidade, ordem e crie visualizações personalizadas.",
	"Manage Views": "Gerenciar Visualizações",
	"Configure sidebar views, order, visibility, and hide/show completed tasks per view.":
		"Configure as visualizações da barra lateral, ordem, visibilidade e oculte/mostre tarefas concluídas por visualização.",
	...
	"Overrides the locale default for calendar views.":
		"Substitui o padrão da localidade para visualizações de calendário.",
	"Show checkbox": "Mostrar caixa de seleção",
	"Show a checkbox for each task in the kanban view.":
		"Mostrar uma caixa de seleção para cada tarefa na visualização kanban.",
	"Locale Default": "Padrão da Localidade",
	"Use custom goal for progress bar":
		"Usar meta personalizada para barra de progresso",
	"Toggle this to allow this plugin to find the pattern g::number as goal of the parent task.":
		"Ative para permitir que este plugin encontre o padrão g::número como meta da tarefa pai.",
	...
	"You can choose dataview format or tasks format, that will influence both index and save format.":
		"Você pode escolher o formato dataview ou o formato tasks, o que influenciará tanto o índice quanto o formato de salvamento.",
	...
	"Select the type of view to create":
		"Selecione o tipo de visualização a criar",
	...
	"Select which task property to use for left column grouping":
		"Selecione qual propriedade da tarefa usar para agrupamento na coluna esquerda",
	...
	"Title for the left column (items list)":
		"Título para a coluna esquerda (lista de itens)",
	"Right Column Title": "Título da Coluna Direita",
	"Default title for the right column (tasks list)":
		"Título padrão para a coluna direita (lista de tarefas)",
	"Multi-select Text": "Texto da Multisseleção",
	"Text to show when multiple items are selected":
		"Texto a ser mostrado quando múltiplos itens são selecionados",
	"Empty State Text": "Texto de Estado Vazio",
	"Text to show when no items are selected":
		"Texto a ser mostrado quando nenhum item é selecionado",
	"Filter Blanks": "Filtrar Itens em Branco",
	"Filter out blank tasks in this view.":
		"Filtrar tarefas em branco nesta visualização.",
	"Task must contain this path (case-insensitive). Separate multiple paths with commas.":
		"A tarefa deve conter este caminho (não diferencia maiúsculas/minúsculas). Separe múltiplos caminhos com vírgulas.",
	"Task must NOT contain this path (case-insensitive). Separate multiple paths with commas.":
		"A tarefa NÃO deve conter este caminho (não diferencia maiúsculas/minúsculas). Separe múltiplos caminhos com vírgulas.",
	"You have unsaved changes. Save before closing?":
		"Você tem alterações não salvas. Salvar antes de fechar?",
	Rotate: "Girar",
	"Are you sure you want to force reindex all tasks?":
		"Tem certeza de que deseja forçar a reindexação de todas as tarefas?",
	"Enable progress bar in reading mode":
		"Ativar barra de progresso no modo de leitura",
	"Toggle this to allow this plugin to show progress bars in reading mode.":
		"Ative para permitir que este plugin mostre barras de progresso no modo de leitura.",
	Range: "Intervalo",
	"as a placeholder for the percentage value":
		"como um marcador para o valor da porcentagem",
	...
	"Standard project management workflow":
		"Fluxo de trabalho padrão de gerenciamento de projetos",
	...
	"Watch an episode of a favorite series":
		"Assistir a um episódio de uma série favorita",
	...
	"Click the open habit button to create a new habit.":
		"Clique no botão abrir hábito para criar um novo hábito.",
	...
	"Record numeric values, e.g., how many cups of water":
		"Registrar valores numéricos, ex.: quantos copos de água",
	"Mapping habit": "Hábito de mapeamento",
	"Use different values to map, e.g., emotion tracking":
		"Usar valores diferentes para mapear, ex.: acompanhamento de emoções",
	...
	"The property name of the daily note front matter":
		"O nome da propriedade no front matter da nota diária",
	...
	"(Optional) Specific text representing completion, leave blank for any non-empty value to be considered completed":
		"(Opcional) Texto específico representando conclusão, deixe em branco para que qualquer valor não vazio seja considerado concluído",
	"The property name in daily note front matter to store count values":
		"O nome da propriedade no front matter da nota diária para armazenar valores de contagem",
	"Minimum value": "Valor mínimo",
	"(Optional) Minimum value for the count":
		"(Opcional) Valor mínimo para a contagem",
	"Maximum value": "Valor máximo",
	"(Optional) Maximum value for the count":
		"(Opcional) Valor máximo para a contagem",
	Unit: "Unidade",
	"(Optional) Unit for the count, such as 'cups', 'times', etc.":
		"(Opcional) Unidade para a contagem, como 'copos', 'vezes', etc.",
	"Notice threshold": "Limite de aviso",
	"(Optional) Trigger a notification when this value is reached":
		"(Opcional) Acionar uma notificação quando este valor for atingido",
	"The property name in daily note front matter to store mapping values":
		"O nome da propriedade no front matter da nota diária para armazenar valores de mapeamento",
	"Value mapping": "Mapeamento de valor",
	"Define mappings from numeric values to display text":
		"Definir mapeamentos de valores numéricos para texto de exibição",
	"Add new mapping": "Adicionar novo mapeamento",
	"Scheduled events": "Eventos agendados",
	"Add multiple events that need to be completed":
		"Adicionar múltiplos eventos que precisam ser concluídos",
	...
	"Please add at least one mapping value":
		"Por favor, adicione pelo menos um valor de mapeamento",
	"Mapping key must be a number": "A chave de mapeamento deve ser um número",
	"Please enter text for all mapping values":
		"Por favor, insira texto para todos os valores de mapeamento",
	...
	"Enable task genius view will also enable the task genius indexer, which will provide the task genius view results from whole vault.":
		"Ativar a visualização Task Genius também ativará o indexador Task Genius, que fornecerá os resultados da visualização Task Genius de todo o cofre.",
	...
	"If enabled, the daily note path will be used as the date for tasks.":
		"Se ativado, o caminho da nota diária será usado como data para as tarefas.",
	"Task Genius will use moment.js and also this format to parse the daily note path.":
		"O Task Genius usará moment.js e também este formato para analisar o caminho da nota diária.",
	"You need to set `yyyy` instead of `YYYY` in the format string. And `dd` instead of `DD`.":
		"Você precisa definir `yyyy` em vez de `YYYY` na string de formato. E `dd` em vez de `DD`.",
	...
	"Manage the specific rewards that can be obtained.":
		"Gerencie as recompensas específicas que podem ser obtidas.",
	...
	"Configure habit settings, including adding new habits, editing existing habits, and managing habit completion.":
		"Configure as definições de hábitos, incluindo adicionar novos hábitos, editar hábitos existentes e gerenciar a conclusão de hábitos.",
	"Enable habits": "Ativar hábitos",
	"Task sorting is disabled or no sort criteria are defined in settings.":
		"A ordenação de tarefas está desativada ou nenhum critério de ordenação está definido nas configurações.",
	...
	"Overrides the locale default for forecast views.":
		"Substitui o padrão da localidade para visualizações de previsão.",
	"View type": "Tipo de visualização",
	"Standard view": "Visualização padrão",
	"Two column view": "Visualização em duas colunas",
	"Two column view settings": "Configurações da visualização em duas colunas",
	...
	"Define the order in which tasks should be sorted. Criteria are applied sequentially.":
		"Defina a ordem em que as tarefas devem ser ordenadas. Os critérios são aplicados sequencialmente.",
	"No sort criteria defined. Add criteria below.":
		"Nenhum critério de ordenação definido. Adicione critérios abaixo.",
	Content: "Conteúdo",
	Ascending: "Ascendente",
	Descending: "Descendente",
	"Ascending: High -> Low -> None. Descending: None -> Low -> High":
		"Ascendente: Alta -> Baixa -> Nenhuma. Descendente: Nenhuma -> Baixa -> Alta",
	"Ascending: Earlier -> Later -> None. Descending: None -> Later -> Earlier":
		"Ascendente: Mais Cedo -> Mais Tarde -> Nenhuma. Descendente: Nenhuma -> Mais Tarde -> Mais Cedo",
	"Ascending respects status order (Overdue first). Descending reverses it.":
		"Ascendente respeita a ordem do status (Atrasadas primeiro). Descendente a inverte.",
	...
	"Only show tasks that match the completed date.":
		"Mostrar apenas tarefas que correspondem à data de conclusão.",
	...
	"Use relative time for date in task list item, e.g. 'yesterday', 'today', 'tomorrow', 'in 2 days', '3 months ago', etc.":
		"Usar tempo relativo para data no item da lista de tarefas, ex.: 'ontem', 'hoje', 'amanhã', 'em 2 dias', 'há 3 meses', etc.",
	"Ignore all tasks behind heading":
		"Ignorar todas as tarefas após o cabeçalho",
	"Enter the heading to ignore, e.g. '## Project', '## Inbox', separated by comma":
		"Insira o cabeçalho a ser ignorado, ex.: '## Projeto', '## Caixa de Entrada', separado por vírgula",
	...
	"Enter the heading to focus, e.g. '## Project', '## Inbox', separated by comma":
		"Insira o cabeçalho para focar, ex.: '## Projeto', '## Caixa de Entrada', separado por vírgula",
	"Enable rewards": "Ativar recompensas",
	"Reward display type": "Tipo de exibição da recompensa",
	"Choose how rewards are displayed when earned.":
		"Escolha como as recompensas são exibidas ao serem ganhas.",
	...
	"Enter a name for this filter configuration":
		"Insira um nome para esta configuração de filtro",
	...
	"Enter a description for this filter configuration (optional)":
		"Insira uma descrição para esta configuração de filtro (opcional)",
	...
	"Select a saved filter configuration":
		"Selecione uma configuração de filtro salva",
	Load: "Carregar",
	Created: "Criado",
	Updated: "Atualizado",
	...
	"Filter configuration name is required":
		"O nome da configuração do filtro é obrigatório",
	"Failed to save filter configuration":
		"Falha ao salvar configuração do filtro",
	"Filter configuration saved successfully":
		"Configuração do filtro salva com sucesso",
	"Failed to load filter configuration":
		"Falha ao carregar configuração do filtro",
	"Filter configuration loaded successfully":
		"Configuração do filtro carregada com sucesso",
	"Failed to delete filter configuration":
		"Falha ao excluir configuração do filtro",
	"Delete Filter Configuration": "Excluir Configuração de Filtro",
	"Are you sure you want to delete this filter configuration?":
		"Tem certeza de que deseja excluir esta configuração de filtro?",
	"Filter configuration deleted successfully":
		"Configuração do filtro excluída com sucesso",
	...
	"Select which task property to use for creating columns":
		"Selecione qual propriedade da tarefa usar para criar colunas",
	...
	"Default field to sort tasks by within each column.":
		"Campo padrão para ordenar tarefas dentro de cada coluna.",
	"Default sort order": "Ordem de ordenação padrão",
	"Default order to sort tasks within each column.":
		"Ordem padrão para ordenar tarefas dentro de cada coluna.",
	"Custom Columns": "Colunas Personalizadas",
	"Configure custom columns for the selected grouping property":
		"Configure colunas personalizadas para a propriedade de agrupamento selecionada",
	"No custom columns defined. Add columns below.":
		"Nenhuma coluna personalizada definida. Adicione colunas abaixo.",
	...
	"Task must have this priority (e.g., 1, 2, 3). You can also use 'none' to filter out tasks without a priority.":
		"A tarefa deve ter esta prioridade (ex.: 1, 2, 3). Você também pode usar 'nenhuma' para filtrar tarefas sem prioridade.",
	"Move all incomplete subtasks to another file":
		"Mover todas as sub-tarefas incompletas para outro arquivo",
	"Move direct incomplete subtasks to another file":
		"Mover sub-tarefas incompletas diretas para outro arquivo",
	Filter: "Filtro",
	...
	"Choose how to calculate the next date for recurring tasks":
		"Escolha como calcular a próxima data para tarefas recorrentes",
	...
	"Toggle this to enable the task gutter.":
		"Ative para habilitar a margem da tarefa.",
	...
	"Toggle this to enable commands for moving incomplete tasks to another file.":
		"Ative para habilitar comandos para mover tarefas incompletas para outro arquivo.",
	...
	"Choose what type of marker to add to moved incomplete tasks":
		"Escolha que tipo de marcador adicionar às tarefas incompletas movidas",
	...
	"Text to append to incomplete tasks when moved (e.g., 'version 1.0')":
		"Texto a ser anexado às tarefas incompletas quando movidas (ex.: 'versão 1.0')",
	...
	"Text to append to incomplete tasks when moved (e.g., 'moved on 2023-12-31')":
		"Texto a ser anexado às tarefas incompletas quando movidas (ex.: 'movida em 2023-12-31')",
	"Incomplete custom marker text":
		"Texto do marcador personalizado incompleto",
	"With current file link for incomplete tasks":
		"Com link do arquivo atual para tarefas incompletas",
	"A link to the current file will be added to the parent task of the moved incomplete tasks.":
		"Um link para o arquivo atual será adicionado à tarefa pai das tarefas incompletas movidas.",
	...
	"You can modify all settings below. The original view will remain unchanged.":
		"Você pode modificar todas as configurações abaixo. A visualização original permanecerá inalterada.",
	...
	"Current status management and date management may conflict with the Tasks plugin. Please check the ":
		"O gerenciamento de status atual e o gerenciamento de datas podem entrar em conflito com o plugin Tasks. Por favor, verifique a ",
	...
	"Automatically manage dates based on task status changes":
		"Gerenciar datas automaticamente com base nas alterações de status da tarefa",
	...
	"Toggle this to enable automatic date management when task status changes. Dates will be added/removed based on your preferred metadata format (Tasks emoji format or Dataview format).":
		"Ative para habilitar o gerenciamento automático de datas quando o status da tarefa mudar. Datas serão adicionadas/removidas com base no seu formato de metadados preferido (formato emoji do Tasks ou formato Dataview).",
	...
	"Automatically add completion dates when tasks are marked as completed, and remove them when changed to other statuses.":
		"Adicionar automaticamente datas de conclusão quando as tarefas são marcadas como concluídas e removê-las quando alteradas para outros status.",
	...
	"Automatically add start dates when tasks are marked as in progress, and remove them when changed to other statuses.":
		"Adicionar automaticamente datas de início quando as tarefas são marcadas como em andamento e removê-las quando alteradas para outros status.",
	...
	"Automatically add cancelled dates when tasks are marked as abandoned, and remove them when changed to other statuses.":
		"Adicionar automaticamente datas de cancelamento quando as tarefas são marcadas como abandonadas e removê-las quando alteradas para outros status.",
	"Copy View": "Copiar Visualização",
	Beta: "Beta",
	...
	"Experimental features that are currently in testing phase. These features may be unstable and could change or be removed in future updates.":
		"Recursos experimentais que estão atualmente em fase de teste. Estes recursos podem ser instáveis e podem mudar ou ser removidos em atualizações futuras.",
	...
	"These features are experimental and may be unstable. They could change significantly or be removed in future updates due to Obsidian API changes or other factors. Please use with caution and provide feedback to help improve these features.":
		"Estes recursos são experimentais e podem ser instáveis. Eles podem mudar significativamente ou ser removidos em atualizações futuras devido a alterações na API do Obsidian ou outros fatores. Use com cautela e forneça feedback para ajudar a melhorar esses recursos.",
	...
	"Advanced view management features that extend the default Task Genius views with additional functionality.":
		"Recursos avançados de gerenciamento de visualização que estendem as visualizações padrão do Task Genius com funcionalidades adicionais.",
	"Enable experimental Base View functionality. This feature provides enhanced view management capabilities but may be affected by future Obsidian API changes. You may need to restart Obsidian to see the changes.":
		"Ativar funcionalidade experimental de Visualização Base. Este recurso oferece capacidades aprimoradas de gerenciamento de visualização, mas pode ser afetado por futuras alterações na API do Obsidian. Pode ser necessário reiniciar o Obsidian para ver as alterações.",
	"You need to close all bases view if you already create task view in them and remove unused view via edit them manually when disable this feature.":
		"Você precisa fechar todas as visualizações base se já criou visualizações de tarefas nelas e remover visualizações não utilizadas editando-as manualmente ao desabilitar este recurso.",
	...
	"Enable experimental Base View functionality. This feature provides enhanced view management capabilities but may be affected by future Obsidian API changes.":
		"Ativar funcionalidade experimental de Visualização Base. Este recurso oferece capacidades aprimoradas de gerenciamento de visualização, mas pode ser afetado por futuras alterações na API do Obsidian.",
	Enable: "Ativar",
	"Beta Feedback": "Feedback Beta",
	"Help improve these features by providing feedback on your experience.":
		"Ajude a melhorar estes recursos fornecendo feedback sobre sua experiência.",
	...
	"If you encounter any issues with beta features, please report them to help improve the plugin.":
		"Se você encontrar quaisquer problemas com os recursos beta, por favor, relate-os para ajudar a melhorar o plugin.",
	...
	"Use advanced multi-group filtering with complex conditions":
		"Use filtragem avançada multi-grupo com condições complexas",
