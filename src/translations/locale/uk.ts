...
const translations = {
	...
	"Toggle this to show the progress bar.":
		"Увімкніть для відображення прогрес-бару.",
	...
	"Toggle this to allow this plugin to show progress info when hovering over the progress bar.":
		"Увімкніть для відображення додаткової інформації при наведенні на прогрес-бар.",
	...
	"Toggle this to allow adding progress bars to regular list items (non-task bullets).":
		"Увімкніть для додавання прогрес-бару до звичайних елементів списку (не завдань).",
	...
	"Toggle this to allow this plugin to add progress bar for Task below the headings.":
		"Увімкніть для додавання прогрес-бару для завдань під заголовками.",
	...
	"Hide progress bars based on conditions":
		"Приховувати прогрес-бар за певних умов",
	"Toggle this to enable hiding progress bars based on tags, folders, or metadata.":
		"Ховати прогрес-бар за умовами на основі міток, тек, або властивостей.",
	...
	'Specify folder paths that will hide progress bars (comma-separated). Example: "Daily Notes,Projects/Hidden"':
		'Вкажіть шлях до тек в яких приховуватиметься прогрес-бар (через кому). Наприклад: "Daily Notes,Projects/Hidden"',
	...
	'Specify frontmatter metadata that will hide progress bars. Example: "hide-progress-bar: true"':
		'Вкажіть властивість, яка приховуватиме прогрес-бар у нотатці. Наприклад: "hide-progress-bar:true"',
	...
	"Emoji mark to identify dates. You can use multiple emoji separated by commas.":
		"Емодзі іконки для позначення дат. Можна використовувати кілька емодзі, розділених комами.",
	...
	"Text to append to incomplete tasks when moved (e.g., 'moved on 2023-12-31')":
		"Текст, який додається до незавершених завдань при переміщенні (наприклад: 'переміщено 2023-12-31')",
	"Incomplete custom marker text": "Текст маркера незавершеного",
	"With current file link for incomplete tasks":
		"З поточним посиланням на файл для незавершених завдань",
	"A link to the current file will be added to the parent task of the moved incomplete tasks.":
		"Посилання на поточний файл буде додано до батьківського завдання переміщених незавершених завдань.",
	"Move all incomplete subtasks to another file":
		"Перемістити всі підзавдання до іншого файлу",
	"Move direct incomplete subtasks to another file":
		"Перемістити прямі незавершені підзавдання до іншого файлу",
	"moved on": "переміщено",
	...
	"You can customize the progress bar behind the parent task(usually at the end of the task). You can also customize the progress bar for the task below the heading.":
		"Налаштування відображення прогресу виконання у батьківському завданні (зазвичай наприкінці завдання). Також можна налаштувати прогрес-бару завдань під заголовками.",
	...
	"A unique identifier for the stage (used in tags)":
		"Унікальний ідентифікатор етапу (використовується у мітках)",
	...
	"This will replace all your current presets with the default set. Are you sure?":
		"Це замінить усі ваші поточні типові фільтри на набір за замовчуванням. Ви впевнені?",
	"Edit Workflow": "Редагувати робочий процес",
	General: "Загальні",
	...
	"Choose how to display task progress":
		"Оберіть відображення для прогрес-бару",
	...
	"Use placeholders like {{COMPLETED}}, {{TOTAL}}, {{PERCENT}}, etc.":
		"Використовуйте такі заповнювачі: {{COMPLETED}}, {{TOTAL}}, {{PERCENT}} тощо.",
	...
	"Configure sidebar views, order, visibility, and hide/show completed tasks per view.":
		"Налаштуйте вигляди бічної панелі, їхній порядок, видимість завершених завдань для кожного подання.",
	...
	"Show a checkbox for each task in the kanban view.":
		"Показувати прапорець кожного завдання у вигляді канбан.",
	...
	"Task must NOT contain this path (case-insensitive). Separate multiple paths with commas.":
		"Завдання НЕ має містити цей шлях (без урахування регістру). Розділяйте кілька шляхів комами.",
	"You have unsaved changes. Save before closing?":
		"Ви маєте незбережені зміни. Зберегти перед закриттям?",
	Rotate: "Повернути",
	"Are you sure you want to force reindex all tasks?":
		"Ви дійсно бажаєте примусово переіндексувати всі завдання?",
	"Enable progress bar in reading mode":
		"Відображати прогрес-бар у режимі читання",
	"Toggle this to allow this plugin to show progress bars in reading mode.":
		"Увімкніть для відображення прогрес-бару у режимі читання.",
	Range: "Діапазон",
	...
	"Standard project management workflow":
		"Стандартний процес керування проєктами",
	...
	"Record numeric values, e.g., how many cups of water":
		"Записуйте кількість зробленого, наприклад: лічильник чашок води",
	"Mapping habit": "Зіставна",
	"Use different values to map, e.g., emotion tracking":
		"Використовуйте різні значення для зіставлення, наприклад: відстеження емоцій",
	...
	"(Optional) Maximum value for the count":
		"(Необов’язково) Максимальне значення лічильника",
	Unit: "Одиниця",
	"(Optional) Unit for the count, such as 'cups', 'times', etc.":
		"(Необов’язково) Одиниця підрахунку, наприклад: 'чашки', 'рази' тощо.",
	"Notice threshold": "Поріг сповіщення",
	"(Optional) Trigger a notification when this value is reached":
		"(Необов’язково) Сповіщати при досягненні цього значення",
	"The property name in daily note front matter to store mapping values":
		"Назва властивості у щоденній нотатці де зберігатимуться значення зіставлення",
	...
	"Use daily note path as date":
		"Використати дату як шлях до щоденної нотатки",
	...
	"Task Genius will use moment.js and also this format to parse the daily note path.":
		"Task Genius буде використовувати moment.js та цей формат, для обробки шляху щоденної нотатки.",
	...
	"Task sorting is disabled or no sort criteria are defined in settings.":
		"Сортування завдань вимкнено, або не визначені критерії сортування у нааштунках.",
	...
	"You can modify all settings below. The original view will remain unchanged.":
		"Ви можете змінити всі налаштування нижче. Початковий вигляд залишиться незмінним.",
	"View copied successfully: ": "Вигляд успішно скопійовано: ",
	"Edit view: ": "Редагувати подання: ",
	"Icon name": "Назва іконки",
	"First day of week": "Перший день тижня",
	"Overrides the locale default for forecast views.":
		"Перевизначає типові локальні у перегляді Прогнозу.",
	...
	"Define the order in which tasks should be sorted. Criteria are applied sequentially.":
		"Визначити порядок сортування завдань. Критерії застосовуються послідовно.",
	"No sort criteria defined. Add criteria below.":
		"Критерії сортування не визначені. Створіть новий нижче.",
	Content: "Зміст",
	Ascending: "Зростання",
	Descending: "Спадання",
	"Ascending: High -> Low -> None. Descending: None -> Low -> High":
		"Зростання: Високий -> Низький -> Немає. Спадання: Немає -> Низький -> Високийigh",
	"Ascending: Earlier -> Later -> None. Descending: None -> Later -> Earlier":
		"Зростання: Раніше -> Пізніше -> Немає. Спадання: Немає -> Пізніше -> Раніше",
	"Ascending respects status order (Overdue first). Descending reverses it.":
		"Зростання дотримується порядку стану (Прострочені першими). Спадання - змінює його на протилежний.",
	...
	"Only show tasks that match the completed date.":
		"Відображати лише завдання, котрі відповідають завершеній даті.",
	...
	"Use relative time for date in task list item, e.g. 'yesterday', 'today', 'tomorrow', 'in 2 days', '3 months ago', etc.":
		"Використовувати відносний час дат у переліку завдань, наприклад: 'вчора', 'сьогодні', 'завтра', 'через 2 дні', '3 місяці тому' і т.д.",
	...
	"Enter the heading to ignore, e.g. '## Project', '## Inbox', separated by comma":
		"Вкажіть заголовки для ігнорування, тобто: '## Проєкт', '## Вхідні' (розділені комами)",
	...
	"Enter the heading to focus, e.g. '## Project', '## Inbox', separated by comma":
		"Вкажіть заголовки для фокусування, тобто: '## Проєкт', '## Вхідні' (розділені комами)",
	"Level Name (e.g., common)": "Назва рівня, наприклад: звичайний",
	"Delete Level": "Видалити рівень",
	...
	"Task must have this priority (e.g., 1, 2, 3). You can also use 'none' to filter out tasks without a priority.":
		"Завдання повинно мати цей пріоритет (наприклад: 1, 2, 3). Також можна використовувати 'none', для фільтрації завдань без пріоритету.",
	Filter: "Фільтр",
	...
	"Choose how to calculate the next date for recurring tasks":
		"Оберіть, як розрахувати наступну дату для повторюваних завдань",
	...
	"Toggle this to enable the task gutter.":
		"Перемкніть для увімкнення бічної панелі деталей завдання.",
	...
	"Current status management and date management may conflict with the Tasks plugin. Please check the ":
		"Управління поточним статусом та датами можуть конфліктувати з додатком Tasks. Будь ласка, перевірте ",
	...
	"Automatically manage dates based on task status changes":
		"Автоматично управляйте датами на основі змін стану завдань",
	...
	"Toggle this to enable automatic date management when task status changes. Dates will be added/removed based on your preferred metadata format (Tasks emoji format or Dataview format).":
		"Увімкніть для активації автоматичного управління датами при зміні стану завдань. Дати будуть додаватися/видалятися згідно з вказаним форматом метаданих (Формат emoji, або Формат Dataview).",
	...
	"Automatically add completion dates when tasks are marked as completed, and remove them when changed to other statuses.":
		"Автоматично додавати дати завершення, коли завдання завершені, та видаляти їх при перемиканні в інші статуси.",
	...
	"Automatically add start dates when tasks are marked as in progress, and remove them when changed to other statuses.":
		"Автоматично додавати дату початку, коли завдання позначено 'в процесі', та видаляти їх при перемиканні в інші статуси.",
	...
	"Automatically add cancelled dates when tasks are marked as abandoned, and remove them when changed to other statuses.":
		"Автоматично додавати дати скасування, коли завдання вважаються покинутими, та видаляти їх при перемиканні в інші статуси.",
	Beta: "Бета",
	...
	"Experimental features that are currently in testing phase. These features may be unstable and could change or be removed in future updates.":
		"Експериментальні функції, які наразі знаходяться на стадії тестування. Ці функції можуть бути нестабільними та можуть змінюватися, або бути видаленими в майбутніх оновленнях.",
	...
	"These features are experimental and may be unstable. They could change significantly or be removed in future updates due to Obsidian API changes or other factors. Please use with caution and provide feedback to help improve these features.":
		"Ці функції експериментальні та можуть бути нестабільними. Вони можуть суттєво змінитися, або бути видаленими в майбутніх оновленнях через зміни API Obsidian, або інші фактори. Будь ласка, використовуйте з обережністю та надайте відгуки, щоб допомогти покращити роботу.",
	...
	"Advanced view management features that extend the default Task Genius views with additional functionality.":
		"Розширені можливості управління переглядом, які доповнюють стандартний перегляд Task Genius додатковим функціоналом.",
	...
	"Enable experimental Base View functionality. This feature provides enhanced view management capabilities but may be affected by future Obsidian API changes.":
		"Увімкнути експериментальні функції перегляду Баз. Функція забезпечує вдосконалені можливості керування, але її можуть змінити з подальшими змінами API Obsidian.",
	Enable: "Увімкнути",
	"Beta Feedback": "Відгук про бета-версію",
	"Help improve these features by providing feedback on your experience.":
		"Допоможіть покращити ці функції, надіславши відгук про свій досвід.",
	...
	"If you encounter any issues with beta features, please report them to help improve the plugin.":
		"Якщо у вас виникли проблеми з бета-функціями, повідомте про них, щоб покращити додаток.",
	...
	"Use advanced multi-group filtering with complex conditions":
		"Використати розширену фільтрацію зі складними умовами",
