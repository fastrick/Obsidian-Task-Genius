...
const translations = {
	...
	"Toggle this to show the progress bar.":
		"Включите, чтобы отобразить индикатор прогресса.",
	"Support hover to show progress info":
		"Показывать информацию о прогрессе при наведении",
	"Toggle this to allow this plugin to show progress info when hovering over the progress bar.":
		"Включите, чтобы плагин показывал информацию о прогрессе при наведении на индикатор.",
	"Add progress bar to non-task bullet":
		"Добавить индикатор прогресса к обычным элементам списка",
	"Toggle this to allow adding progress bars to regular list items (non-task bullets).":
		"Включите, чтобы добавить индикаторы прогресса к обычным элементам списка (не задачам).",
	...
	"Toggle this to allow this plugin to add progress bar for Task below the headings.":
		"Включите, чтобы плагин добавлял индикатор прогресса для задач под заголовками.",
	"Enable heading progress bars":
		"Включить индикаторы прогресса для заголовков",
	"Add progress bars to headings to show progress of all tasks under that heading.":
		"Добавьте индикаторы прогресса к заголовкам, чтобы показать прогресс всех задач под этим заголовком.",
	...
	"Toggle this to allow this plugin to auto complete parent task when all child tasks are completed.":
		"Включите, чтобы плагин автоматически завершал родительскую задачу, когда все дочерние задачи завершены.",
	"Mark parent as 'In Progress' when partially complete":
		"Отмечать родительскую задачу как 'В процессе', если завершена частично",
	...
	'Specify task markers to exclude from counting. Example: "?|/"':
		'Укажите маркеры задач, которые нужно исключить из подсчета. Пример: "?|/"',
	"Only count specific task markers":
		"Учитывать только определенные маркеры задач",
	"Toggle this to only count specific task markers":
		"Включите, чтобы учитывать только определенные маркеры задач",
	"Specific task markers to count": "Определенные маркеры задач для подсчета",
	'Specify which task markers to count. Example: "x|X|>|/"':
		'Укажите, какие маркеры задач учитывать. Пример: "x|X|>|/"',
	"Conditional Progress Bar Display":
		"Условное отображение индикатора прогресса",
	"Hide progress bars based on conditions":
		"Скрывать индикаторы прогресса по условиям",
	"Toggle this to enable hiding progress bars based on tags, folders, or metadata.":
		"Включите, чтобы скрывать индикаторы прогресса на основе тегов, папок или метаданных.",
	...
	'Specify tags that will hide progress bars (comma-separated, without #). Example: "no-progress-bar,hide-progress"':
		'Укажите теги, которые будут скрывать индикаторы прогресса (через запятую, без #). Пример: "no-progress-bar,hide-progress"',
	...
	'Specify folder paths that will hide progress bars (comma-separated). Example: "Daily Notes,Projects/Hidden"':
		'Укажите пути к папкам, которые будут скрывать индикаторы прогресса (через запятую). Пример: "Daily Notes,Projects/Hidden"',
	...
	'Specify frontmatter metadata that will hide progress bars. Example: "hide-progress-bar: true"':
		'Укажите метаданные frontmatter, которые будут скрывать индикаторы прогресса. Пример: "hide-progress-bar: true"',
	...
	"Enable/disable the ability to cycle through task states by clicking.":
		"Включить/отключить возможность переключения статусов задач по клику.",
	...
	"Replace default checkboxes with styled text marks that follow your task status cycle when clicked.":
		"Замените стандартные флажки на стилизованные текстовые маркеры, которые следуют вашему циклу статусов задач при клике.",
	...
	"Enable/disable the ability to automatically cycle through task states when pressing a mark.":
		"Включить/отключить автоматическое переключение статусов задач при нажатии на маркер.",
	...
	"When enabled, newly inserted tasks will immediately cycle to the next status. When disabled, newly inserted tasks with valid marks will keep their original mark.":
		"Если включено, новые задачи будут сразу переключаться на следующий статус. Если отключено, новые задачи с допустимыми маркерами сохранят свой изначальный маркер.",
	...
	"Define task states and their corresponding marks. The order from top to bottom defines the cycling sequence.":
		"Определите состояния задач и соответствующие им маркеры. Порядок сверху вниз определяет последовательность переключения.",
	...
	"A link to the current file will be added to the parent task of the moved tasks.":
		"Ссылка на текущий файл будет добавлена к родительской задаче перемещенных задач.",
	"Say Thank You": "Сказать спасибо",
	Donate: "Пожертвовать",
	"If you like this plugin, consider donating to support continued development:":
		"Если вам нравится этот плагин, подумайте о пожертвовании для поддержки дальнейшей разработки:",
	...
	"Toggle this to allow this plugin to add tasks number to progress bar.":
		"Включите, чтобы плагин добавлял число задач к индикатору прогресса.",
	"Show percentage": "Показать процент",
	"Toggle this to allow this plugin to show percentage in the progress bar.":
		"Включите, чтобы плагин показывал процент в индикаторе прогресса.",
	...
	"Toggle to enable priority picker dropdown for emoji and letter format priorities.":
		"Включите, чтобы активировать выпадающий список выбора приоритета для форматов с эмодзи и буквами.",
	"Enable priority picker": "Включить выбор приоритета",
	"Enable priority keyboard shortcuts":
		"Включить горячие клавиши для приоритета",
	"Toggle to enable keyboard shortcuts for setting task priorities.":
		"Включите, чтобы активировать горячие клавиши для установки приоритетов задач.",
	...
	"Toggle this to enable date picker for tasks. This will add a calendar icon near your tasks which you can click to select a date.":
		"Включите, чтобы активировать выбор даты для задач. Это добавит иконку календаря рядом с задачами, на которую можно нажать для выбора даты.",
	"Date mark": "Маркер даты",
	"Emoji mark to identify dates. You can use multiple emoji separated by commas.":
		"Эмодзи-маркер для обозначения дат. Можно использовать несколько эмодзи, разделенных запятыми.",
	...
	"Toggle this to enable Org-mode style quick capture panel. Press Alt+C to open the capture panel.":
		"Включите, чтобы активировать панель быстрого захвата в стиле Org-mode. Нажмите Alt+C, чтобы открыть панель захвата.",
	"Target file": "Целевой файл",
	"The file where captured text will be saved. You can include a path, e.g., 'folder/Quick Capture.md'":
		"Файл, в котором будет сохранен захваченный текст. Можно указать путь, например, 'folder/Quick Capture.md'",
	"Placeholder text": "Текст-заполнитель",
	"Placeholder text to display in the capture panel":
		"Текст-заполнитель для отображения в панели захвата",
	...
	"If enabled, captured text will be appended to the target file. If disabled, it will replace the file content.":
		"Если включено, захваченный текст будет добавлен в целевой файл. Если отключено, он заменит содержимое файла.",
	"Task Filter": "Фильтр задач",
	"Enable Task Filter": "Включить фильтр задач",
	"Toggle this to enable the task filter panel":
		"Включите, чтобы активировать панель фильтра задач",
	"Preset Filters": "Предустановленные фильтры",
	"Create and manage preset filters for quick access to commonly used task filters.":
		"Создавайте и управляйте предустановленными фильтрами для быстрого доступа к часто используемым фильтрам задач.",
	...
	"Include or exclude tasks based on their status":
		"Включать или исключать задачи на основе их статуса",
	...
	"Include parent, child, and sibling tasks in the filter":
		"Включить родительские, дочерние и соседние задачи в фильтр",
	...
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1'":
		"Используйте булевы операции: AND, OR, NOT. Пример: 'text content AND #tag1'",
	...
	"If enabled, tasks that match the query will be hidden, otherwise they will be shown":
		"Если включено, задачи, соответствующие запросу, будут скрыты, иначе они будут показаны",
	Save: "Сохранить",
	Cancel: "Отмена",
	...
	"Select a saved filter preset to apply":
		"Выберите сохраненный предустановленный фильтр для применения",
	...
	"Use boolean operations: AND, OR, NOT. Example: 'text content AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Supports >, <, =, >=, <=, != for PRIORITY and DATE.":
		"Используйте булевы операции: AND, OR, NOT. Пример: 'text content AND #tag1 AND DATE:<2022-01-02 NOT PRIORITY:>=#B' - Поддерживает >, <, =, >=, <=, != для PRIORITY и DATE.",
	...
	"Capture thoughts, tasks, or ideas...":
		"Захватывайте мысли, задачи или идеи...",
	Tomorrow: "Завтра",
	...
	"Move all completed subtasks to another file":
		"Переместить все завершенные подзадачи в другой файл",
	"Move direct completed subtasks to another file":
		"Переместить прямые завершенные подзадачи в другой файл",
	"Move all subtasks to another file":
		"Переместить все подзадачи в другой файл",
	...
	"Choose whether to include or exclude tasks that match the filters":
		"Выберите, включать или исключать задачи, соответствующие фильтрам",
	...
	"Choose whether to show or hide tasks that match the filters":
		"Выберите, показывать или скрывать задачи, соответствующие фильтрам",
	...
	"Add child task with same stage":
		"Добавить дочернюю задачу с тем же этапом",
	"Could not open quick capture panel in the current editor":
		"Не удалось открыть панель быстрого захвата в текущем редакторе",
	...
	"You can customize the progress bar behind the parent task(usually at the end of the task). You can also customize the progress bar for the task below the heading.":
		"Вы можете настроить индикатор прогресса за родительской задачей (обычно в конце задачи). Также можно настроить индикатор прогресса для задач под заголовком.",
	...
	"Change the parent task of the current task.":
		"Изменить родительскую задачу текущей задачи.",
	"No preset filters created yet. Click 'Add New Preset' to create one.":
		"Предустановленные фильтры еще не созданы. Нажмите 'Добавить новую предустановку', чтобы создать одну.",
	"Configure task workflows for project and process management":
		"Настройте рабочие процессы задач для управления проектами и процессами",
	"Enable workflow": "Включить рабочий процесс",
	"Toggle to enable the workflow system for tasks":
		"Включите, чтобы активировать систему рабочих процессов для задач",
	"Auto-add timestamp": "Автоматически добавлять временную метку",
	"Automatically add a timestamp to the task when it is created":
		"Автоматически добавлять временную метку к задаче при ее создании",
	...
	"Calculate spent time when move to next stage.":
		"Рассчитывать затраченное время при переходе к следующему этапу.",
	...
	"Calculate the full spent time from the start of the task to the last stage":
		"Рассчитывать полное затраченное время от начала задачи до последнего этапа",
	"Auto remove last stage marker":
		"Автоматически удалять маркер последнего этапа",
	"Automatically remove the last stage marker when a task is completed":
		"Автоматически удалять маркер последнего этапа, когда задача завершена",
	...
	"Automatically create a new task with the next stage when completing a task":
		"Автоматически создавать новую задачу с следующим этапом при завершении задачи",
	"Workflow definitions": "Определения рабочих процессов",
	"Configure workflow templates for different types of processes":
		"Настройте шаблоны рабочих процессов для различных типов процессов",
	"No workflow definitions created yet. Click 'Add New Workflow' to create one.":
		"Определения рабочих процессов еще не созданы. Нажмите 'Добавить новый рабочий процесс', чтобы создать один.",
	...
	"A descriptive name for this workflow stage":
		"Описательное имя для этого этапа рабочего процесса",
	"Stage ID": "Идентификатор этапа",
	"A unique identifier for the stage (used in tags)":
		"Уникальный идентификатор для этапа (используется в тегах)",
	...
	"The stage to proceed to after this one":
		"Этап, к которому нужно перейти после этого",
	"Sub-stages": "Подэтапы",
	"Define cycle sub-stages (optional)":
		"Определите циклические подэтапы (необязательно)",
	...
	"Additional stages that can follow this one (for right-click menu)":
		"Дополнительные этапы, которые могут следовать за этим (для контекстного меню)",
	"No additional destination stages defined.":
		"Дополнительные целевые этапы не определены.",
	Remove: "Удалить",
	Add: "Добавить",
	...
	"This will replace all your current presets with the default set. Are you sure?":
		"Это заменит все ваши текущие предустановки на набор по умолчанию. Вы уверены?",
	"Edit Workflow": "Редактировать рабочий процесс",
	General: "Общие",
	"Progress Bar": "Индикатор прогресса",
	...
	"Toggle this to allow this plugin to count sub tasks when generating progress bar\t.":
		"Включите, чтобы плагин учитывал дочерние задачи при создании индикатора прогресса.",
	"Configure task status settings": "Настроить параметры статуса задач",
	"Configure which task markers to count or exclude":
		"Настроить, какие маркеры задач учитывать или исключать",
	...
	"View the documentation for this plugin":
		"Посмотреть документацию для этого плагина",
	...
	"Use placeholders like {{COMPLETED}}, {{TOTAL}}, {{PERCENT}}, etc.":
		"Используйте заполнители, такие как {{COMPLETED}}, {{TOTAL}}, {{PERCENT}} и т.д.",
	...
	"Available placeholders: {{COMPLETED}}, {{TOTAL}}, {{IN_PROGRESS}}, {{ABANDONED}}, {{PLANNED}}, {{NOT_STARTED}}, {{PERCENT}}, {{COMPLETED_SYMBOL}}, {{IN_PROGRESS_SYMBOL}}, {{ABANDONED_SYMBOL}}, {{PLANNED_SYMBOL}}":
		"Доступные заполнители: {{COMPLETED}}, {{TOTAL}}, {{IN_PROGRESS}}, {{ABANDONED}}, {{PLANNED}}, {{NOT_STARTED}}, {{PERCENT}}, {{COMPLETED_SYMBOL}}, {{IN_PROGRESS_SYMBOL}}, {{ABANDONED_SYMBOL}}, {{PLANNED_SYMBOL}}",
	"Expression examples": "Примеры выражений",
	"Examples of advanced formats using expressions":
		"Примеры продвинутых форматов с использованием выражений",
	...
	"Toggle this to show percentage instead of completed/total count.":
		"Включите, чтобы показывать процент вместо количества завершенных/всего.",
	"Customize progress ranges": "Настроить диапазоны прогресса",
	"Toggle this to customize the text for different progress ranges.":
		"Включите, чтобы настроить текст для разных диапазонов прогресса.",
	...
	"Support expression in format, like using data.percentages to get the percentage of completed tasks. And using math or even repeat operations to get the result.":
		"Поддержка выражений в формате, например, использование data.percentages для получения процента завершенных задач. А также использование математических операций или операций повторения для получения результата.",
	"Support expression in format, like using data.percentages to get the percentage of completed tasks. And using math or even repeat functions to get the result.":
		"Поддержка выражений в формате, например, использование data.percentages для получения процента завершенных задач. А также использование математических операций или функций повторения для получения результата.",
	"Target File:": "Целевой файл:",
	...
	"Select a project to review its tasks.":
		"Выберите проект для обзора его задач.",
	...
	"Showing all tasks, including completed tasks from previous reviews.":
		"Показаны все задачи, включая завершенные задачи из предыдущих обзоров.",
	"Show only new and in-progress tasks":
		"Показать только новые и задачи в процессе",
	...
	"No review schedule configured for this project":
		"Для этого проекта не настроен график обзора",
	...
	"Select a project from the left sidebar to review its tasks.":
		"Выберите проект в левой боковой панели, чтобы просмотреть его задачи.",
	Inbox: "Входящие",
	Flagged: "Помеченные",
	Review: "Обзор",
	...
	"Select a tag to see related tasks":
		"Выберите тег, чтобы увидеть связанные задачи",
	...
	"Task Genius view is a comprehensive view that allows you to manage your tasks in a more efficient way.":
		"Вид Task Genius — это комплексный вид, который позволяет более эффективно управлять задачами.",
	"Enable task genius view": "Включить вид Task Genius",
	"Select a task to view details":
		"Выберите задачу, чтобы просмотреть детали",
	Status: "Статус",
	...
	"Enter any Lucide icon name (e.g., list-checks, filter, inbox)":
		"Введите любое имя иконки Lucide (например, list-checks, filter, inbox)",
	"Filter Rules": "Правила фильтрации",
	"Hide Completed and Abandoned Tasks":
		"Скрыть завершенные и заброшенные задачи",
	"Hide completed and abandoned tasks in this view.":
		"Скрыть завершенные и заброшенные задачи в этом виде.",
	"Text Contains": "Текст содержит",
	"Filter tasks whose content includes this text (case-insensitive).":
		"Фильтровать задачи, содержимое которых включает этот текст (без учета регистра).",
	"Tags Include": "Теги включают",
	"Task must include ALL these tags (comma-separated).":
		"Задача должна включать ВСЕ эти теги (разделенные запятыми).",
	"Tags Exclude": "Теги исключают",
	"Task must NOT include ANY of these tags (comma-separated).":
		"Задача НЕ должна включать НИ ОДИН из этих тегов (разделенные запятыми).",
	"Project Is": "Проект",
	"Task must belong to this project (exact match).":
		"Задача должна принадлежать этому проекту (точное совпадение).",
	"Priority Is": "Приоритет",
	"Task must have this priority (e.g., 1, 2, 3).":
		"Задача должна иметь этот приоритет (например, 1, 2, 3).",
	"Status Include": "Статус включает",
	"Task status must be one of these (comma-separated markers, e.g., /,>).":
		"Статус задачи должен быть одним из этих (маркеры, разделенные запятыми, например, /,>).",
	"Status Exclude": "Статус исключает",
	"Task status must NOT be one of these (comma-separated markers, e.g., -,x).":
		"Статус задачи НЕ должен быть одним из этих (маркеры, разделенные запятыми, например, -,x).",
	"Use YYYY-MM-DD or relative terms like 'today', 'tomorrow', 'next week', 'last month'.":
		"Используйте YYYY-MM-DD или относительные термины, такие как 'сегодня', 'завтра', 'на следующей неделе', 'в прошлом месяце'.",
	...
	"Task must contain this path (case-insensitive).":
		"Задача должна содержать этот путь (без учета регистра).",
	"Path Excludes": "Путь исключает",
	"Task must NOT contain this path (case-insensitive).":
		"Задача НЕ должна содержать этот путь (без учета регистра).",
	...
	"Configure the Task Genius sidebar views, visibility, order, and create custom views.":
		"Настройте виды боковой панели Task Genius, их видимость, порядок и создавайте пользовательские виды.",
	"Manage Views": "Управление видами",
	"Configure sidebar views, order, visibility, and hide/show completed tasks per view.":
		"Настройте виды боковой панели, их порядок, видимость и скрытие/показ завершенных задач для каждого вида.",
	...
	"Error: View ID already exists.":
		"Ошибка: Идентификатор вида уже существует.",
	Events: "События",
	Plan: "План",
	Year: "Год",
	Month: "Месяц",
	...
	"Overrides the locale default for calendar views.":
		"Переопределяет настройки локали по умолчанию для видов календаря.",
	"Show checkbox": "Показать флажок",
	"Show a checkbox for each task in the kanban view.":
		"Показывать флажок для каждой задачи в виде канбан.",
	"Locale Default": "Локаль по умолчанию",
	"Use custom goal for progress bar":
		"Использовать пользовательскую цель для индикатора прогресса",
	"Toggle this to allow this plugin to find the pattern g::number as goal of the parent task.":
		"Включите, чтобы плагин искал шаблон g::number как цель родительской задачи.",
