...
describe('CanvasTaskOperationUtils', () => {
	...
	describe('findOrCreateTargetTextNode', () => {
		...
		it('should create new text node without section', async () => {
			...
			const result = await utils.findOrCreateTargetTextNode('test.canvas');
		...
		it('should return null if file does not exist', async () => {
			...
			const result = await utils.findOrCreateTargetTextNode('non-existent.canvas');
	...
	describe('insertTaskIntoSection', () => {
		...
		it('should handle errors gracefully', () => {
			...
			Object.defineProperty(textNode, 'text', {
				get: () => 'content',
				set: () => { throw new Error('Cannot modify text'); }
			});
	...
	describe('saveCanvasData', () => {
		it('should successfully save Canvas data', async () => {
			...
			const result = await utils.saveCanvasData('test.canvas', canvasData);
		...
		it('should handle file not found error', async () => {
			...
			const result = await utils.saveCanvasData('non-existent.canvas', canvasData);
